...
export const ProductList = () => {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    return matchesSearch && matchesCategory && product.userId !== loggedInUserId;
  });
  ...
  return (
    <div style={pageStyle}>
      <NavBar />
      <h1 style={headerStyle}>Browse Products</h1>
          ...
          <div key={product._id} className="col-4">
            ...
            >
              ...
              <div className="card-body">
                ...
                <p style={{ color: "black" }}>Product Detalils: ${product.details}</p>
      ...
      {showFeedbackModal && (
        <div
          style={{
            background: "rgba(2A55, 255, 255, 0.8)",
            borderRadius: "15px",
            backdropFilter: "blur(10px)",
            boxShadow: "0 4px 20px rgba(0, 0, 0, 0.15)",
            position: "fixed",
