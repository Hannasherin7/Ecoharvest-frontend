...
export const FertilizersList = () => {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesCategory = selectedCategory ? product.fertilizercategory === selectedCategory : true;
    const isFertilizerProduct = product.productype === "Fertilizers";
  ...
  const shareProduct = (product) => {
    if (navigator.share) {
      navigator.share({
        title: product.pname,
        text: `Check out this ${product.fertilizercategory} fertilizer on EcoHarvest`,
  ...
  return (
    <div style={{ 
      ...
      <div className="hero-section" style={{
        ...
        right: 0,
        height: "400px",
        background: "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1518977676601-b53f82aba655?ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80')",
        ...
        <p style={{ 
          ...
          Boost your plant growth with our certified fertilizers. Perfect for home gardens and professional farming.
        </p>
          ...
          <div className="row">
            <div className="col-12">
              <h2 style={{
                ...
                {searchTerm ? `Search Results for "${searchTerm}"` : "Featured Fertilizers"}
              </h2>
            </div>
          </div>
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center py-5" style={{ 
              ...
              <img 
                ...
                alt="No fertilizers found" 
                style={{ width: "100px", marginBottom: "20px" }}
              />
              <h3 style={{ color: "#666" }}>No fertilizers found</h3>
